...
export function RegisterRoutes(app: Router) {
  ...
  app.get('/reviews/:id',
    ...(fetchMiddlewares<RequestHandler>(ReviewController)),
    ...(fetchMiddlewares<RequestHandler>(ReviewController.prototype.getReviewsById)),

    async function ReviewController_getReviewsById(request: ExRequest, response: ExResponse, next: any) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
  ...
  app.patch('/games/:id',
    ...(fetchMiddlewares<RequestHandler>(GameController)),
    ...(fetchMiddlewares<RequestHandler>(GameController.prototype.updateGame)),

    async function GameController_updateGame(request: ExRequest, response: ExResponse, next: any) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        id: { "in": "path", "name": "id", "required": true, "dataType": "double" },
        requestBody: { "in": "body", "name": "requestBody", "required": true, "ref": "GameDTO" },
      };
  ...
  // Route GET /consoles/:id/games
  app.get(
    '/consoles/:id/games',
    ...(fetchMiddlewares<RequestHandler>(ConsoleController)),  // Middlewares associés au contrôleur
    ...(fetchMiddlewares<RequestHandler>(ConsoleController.prototype.getGamesByConsoleById)),  // Middlewares spécifiques à la méthode

    async function ConsoleController_getGamesByConsoleById(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        ...
        await templateService.apiHandler({
          methodName: 'getGamesByConsoleById',
          controller,
          response,
          next,
          validatedArgs,
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // Route GET /games/:id/reviews
    app.get(
      '/games/:id/review', 
      ...(fetchMiddlewares<RequestHandler>(GameController)),  
      ...(fetchMiddlewares<RequestHandler>(GameController.prototype.getReviewsByGameById)), 
    
      async function GameController_getReviewsByGameById(
        request: ExRequest,
        response: ExResponse,
        next: any
      ) {
        ...
        try {
          ...
          await templateService.apiHandler({
            methodName: 'getReviewsByGameById',
            controller,
            response,
            next,
            validatedArgs,
